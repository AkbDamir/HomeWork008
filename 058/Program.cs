...
15 18
*/
Console.WriteLine("Введите количествво строк первого массива:");
int rows = int.Parse(Console.ReadLine());
Console.WriteLine("Введите количествво столбцов первого массива:");
int columns = int.Parse(Console.ReadLine());

int[,] matrix1 = FillArray(rows, columns);

Console.WriteLine("Введите количествво строк второго массива:");
rows = int.Parse(Console.ReadLine());
Console.WriteLine("Введите количествво столбцов второго массива:");
